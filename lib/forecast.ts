...
export const historicalSeries = {
  ...
  Banana: {
    '7 Days': [1790, 1810, 1800, 1830, 1820, 1840, 1850],
    '30 Days': [1700, 1730, 1760, 1780, 1800, 1820, 1840, 1850],
    '6 Months': [1560, 1620, 1670, 1710, 1760, 1800, 1830, 1850],
  },

  Grapes: {
    '7 Days': [6320, 6290, 6270, 6250, 6230, 6210, 6200],
    '30 Days': [6540, 6480, 6430, 6380, 6330, 6280, 6240, 6200],
    '6 Months': [5900, 6100, 6350, 6520, 6480, 6390, 6280, 6200],
  },

  Mango: {
    '7 Days': [8300, 8360, 8390, 8420, 8450, 8480, 8500],
    '30 Days': [7950, 8060, 8150, 8240, 8310, 8390, 8450, 8500],
    '6 Months': [7100, 7400, 7680, 7900, 8120, 8290, 8410, 8500],
  },

  Pomegranate: {
    '7 Days': [9080, 9110, 9140, 9160, 9180, 9190, 9200],
    '30 Days': [8800, 8880, 8950, 9020, 9080, 9130, 9170, 9200],
    '6 Months': [8200, 8420, 8610, 8780, 8930, 9050, 9140, 9200],
  },

  Orange: {
    '7 Days': [3460, 3450, 3430, 3420, 3410, 3400, 3400],
    '30 Days': [3580, 3550, 3520, 3490, 3460, 3440, 3420, 3400],
    '6 Months': [3800, 3720, 3650, 3580, 3520, 3470, 3430, 3400],
  },
} as const
